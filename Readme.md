...
By including threads-io-binding.min.js into your page we capture the `success` event generated by the widget and then send a "Subscribed to Newsletter" event on threads (if the threads library is included in the page)

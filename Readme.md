...
If you have additional fields stored by SendGrid that you wish to store with the subscription widget, you must place them in this tag. To determine your fields mappings to our database [the additional fields helper page](http://sendgrid.github.io/sendgrid-subscription-widget/additional-fields.html).
